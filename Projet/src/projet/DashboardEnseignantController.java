...
import projet.absences.Absence;
import projet.absences.AbsenceService;
import projet.absences.FormajoutabsencesController;
import projet.absences.FormmodifierabsenceController;
import projet.moyennes.Moyenne;
import projet.moyennes.MoyenneService;
import projet.moyennes.MoyennesController;
import projet.notes.ModifierNotesFormController;
import projet.notes.Note;
import projet.notes.NoteService;
import projet.notes.NotesFormController;
import projet.sanctions.FormajoutsanctionController;
import projet.sanctions.FormmodifiersanctionController;
import projet.sanctions.Sanction;
import projet.sanctions.SanctionService;
...
public class DashboardEnseignantController implements Initializable {
    ...
    public void ajouterAbsence(ActionEvent event) 
    {
      try
      {    
        FXMLLoader loader = new FXMLLoader(getClass().getResource("absences/formajoutabsences.fxml"));
    ...
    private void AjouterNote(ActionEvent event) 
    {
      try
      {   
        FXMLLoader loader = new FXMLLoader(getClass().getResource("notes/AjouterNotesForm.fxml"));
        Parent root = loader.load();
    ...
    private void AjouterMoyenne(ActionEvent event) 
    {
        ...
        try
        {
          FXMLLoader loader = new FXMLLoader(getClass().getResource("dashboard-enseignant.fxml"));
          Parent root = loader.load();
    ...
    public void ModifierAbsence(ActionEvent event) 
    {
      try
      {    
        FXMLLoader loader = new FXMLLoader(getClass().getResource("absences/formmodifierabsence.fxml"));
    ...
    private void ModifierNote(ActionEvent event) 
    {
      try
      {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("notes/ModifierNotesForm.fxml"));
        Parent root = loader.load();
   ...
   @FXML 
    ...
    private void AjouterSanction(ActionEvent event) 
    {
      try
      {   
        FXMLLoader loader = new FXMLLoader(getClass().getResource("sanctions/formajoutsanction.fxml"));
        Parent root = loader.load();
    ...
    private void ModifierSanction(ActionEvent event) 
    {
        try
        {
          ...
          FXMLLoader loader = new FXMLLoader(getClass().getResource("sanctions/Formmodifiersanction.fxml"));
          Parent root = loader.load();
