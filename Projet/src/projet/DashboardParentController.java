...
public class DashboardParentController implements Initializable {
    ...
    private void afficherSanctions(ActionEvent event) 
    {
        ...
        projet.SanctionsparentController.setIdeleve(i);
    ...
    private void afficherMoyennes(ActionEvent event) 
    {
        ...
        projet.MoyennesparentController.setIdeleve(i);
        
        try
        {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("moyennesparent.fxml"));
            Parent root=loader.load();
    ...
    {     
        ...
        projet.ParentnotesController.setId(i);
        
        try
        {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("parentnotes.fxml"));
            Parent root=loader.load();
    ...
    private void afficherAbs(ActionEvent event) 
    {
        ...
        projet.AbsencesparentController.setIdeleve(i);
        
        try
        {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("absencesparent.fxml"));
            Parent root=loader.load();
